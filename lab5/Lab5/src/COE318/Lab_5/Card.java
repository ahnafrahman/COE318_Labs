...
public class Card implements Comparable {
  ...
  public boolean equals(Object ob) {
    ...
    Card c = (Card) ob;
      return (c.getRank() == getRank() && c.getSuit() == getSuit());
  }
  ...
  public int compareTo(Card c) {
    ...
    //This assumes statement block assumes the method has not been terminated
    //by the previous statements. Meaning the ranks must be equal.
